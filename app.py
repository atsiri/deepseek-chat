...
# page configuration
st.set_page_config(page_title="DeepSeek + Ollama Chat", layout="centered")

def format_reasoning_response(thinking_content):
    """removing think tags from bot output"""
    return (
...
def display_assistant_message(content):
    """display bot message with thinking content if present"""
...
def process_thinking_phase(stream):
    """process the thinking phase of the bot's response."""
    thinking_content = ""
...
def process_response_phase(stream):
    """process the response phase of the bot's response"""
...
@st.cache_resource
def get_chat_model():
    """cached instance of the chat model"""
...
def main():
    ...
    st.markdown("""DeepSeek + Ollama Chatbot <img src="data:image/png;base64,{}" width="170" style="vertical-align: -3px;">
